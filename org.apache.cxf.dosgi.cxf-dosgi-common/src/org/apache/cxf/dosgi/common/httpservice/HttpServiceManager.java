...
public class HttpServiceManager {
    /**
     * Prefix to create an absolute URL from a relative URL. See
     * HttpServiceManager.getAbsoluteAddress Defaults to: http://localhost:8181
     */
    ...
    // final String httpBase = (String) props.get(KEY_HTTP_BASE);
    // if (httpBase != null) {
    // this.httpBase = httpBase;
    // }
    // }

    private void initFromConfig(Dictionary<String, Object> config) {
        if (config == null) {
    ...
    /**
     * This listens for service removal events and "un-exports" the service from the
     * HttpService.
     *
     * @param sref
     *            the service reference to track
     * @param alias
     *            the HTTP servlet context alias
     */
